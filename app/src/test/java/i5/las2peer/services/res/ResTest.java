...
public class ResTest {
  ...
  /**
   * 
   * Test for the NewTestCase_ID489304 method.
   * 
   */
  @Test
  public void testNewTestCase_ID489304() {
...
""", "text/plain", "*/*", new HashMap<>(), new Object[0]);
      System.out.println("Result of request with id: 636767: " + result.getResponse().trim());
    
      Assert.assertEquals("[430574]", 200, result.getHttpCode());
